<?php
 class dataokeAction extends BackendAction{
    ...
    public function index(){
        $zym_68 = C('ftx_dtk');
        if(!$zym_68){
            $zym_67 = '您还没有设置大淘客appkey，请先到大淘客平台申请,<span class="red"><a href="http://www.dataoke.com/ucenter/appkey_apply.asp" target="_blank">点此申请</a></span>,再到网站后台采集设置中填写。';
        }else{
            $zym_67 = '杨他他淘宝客与嗨推网大淘客平台数据合作，可通过大淘客API接口采集内部优惠券及商品数据，<span class="red"><a href="http://bbs.yangtata.com/forum.php?mod=viewthread&tid=5192" target="_blank">点此查看采集教程 </a></span>';
        }
